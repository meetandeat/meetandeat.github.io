var locales = {
  _en: {
    ...
    'headline': {
      ...
      'reservation': 'Reservation',
      'facebook': 'Stay up to date & follow us on ...',
      'footer': 'Additional Information'
    },
    'reservation': {
      'label': {
    ...
    'footer': {
      'supported_by': 'Kindly supported by',
      'imprint': 'Imprint',
      'contact': 'Contact',
      'donations': 'Donations',
    },
    'about': {
      'paragraph1': 'Every day, 30 135 tons of food are thrown away in Germany. This adds up to an annual sum of 11 ' +
      'million tons of wasted food.  The aim of Meet & Eat is to raise awareness of this topic – by sharing food which ' +
      ...
      'jana': 'Jana founded Meet & Eat in 2015 together with a group of former European Volunteers. She is a student ' +
      'living in Berlin and responsible for the events, PR and communications.',

      'stadtteilzentrum': 'The Stadtteilzentrum Pankow (community center of the Berlin district Pankow) hosts the ' +
      'Meet & Eat events. Special thanks go to Katrin and Ira who organize the participants’s ' +
      'reservations and the dinner’s logistics.',

      'tafeln': 'The social organization Berliner Tafel e.V. actively lives the principle of redistribution. ' +
      'They provide us with food which would have been trashed. We are especially grateful to have them as our ' +
      'partners and wish to thank them very much.',
    ...
    'imprint': {
      'headline': {
        ...
        'contact': 'Contact',
        'image_sources': 'Indication of source for images and graphics',
        'acc_content': 'Accountability for content',
        'acc_links': 'Accountability for links',
      ...
      'image_sources': '?',
      'acc_content': "The contents of our pages have been created with the utmost care. However, we cannot guarantee the contents' accuracy, completeness or topicality. According to statutory provisions, we are furthermore responsible for our own content on these web pages. In this context, please note that we are accordingly not obliged to monitor merely the transmitted or saved information of third parties, or investigate circumstances pointing to illegal activity. Our obligations to remove or block the use of information under generally applicable laws remain unaffected by this as per §§ 8 to 10 of the Telemedia Act (TMG).",
      'acc_links': "Responsibility for the content of external links (to web pages of third parties) lies solely with the operators of the linked pages. No violations were evident to us at the time of linking. Should any legal infringement become known to us, we will remove the respective link immediately.",
  ...
  _de: {
    ...
    'headline': {
      ...
      'reservation': 'Anmeldung',
      'facebook': 'Bleib auf dem Laufenden & folge uns bei ...',
      'footer': 'Zusätzliche Informationen'
    },
    'reservation': {
      'label': {
    ...
    'footer': {
      'supported_by': 'Mit freundlicher Unterstützung von',
      'imprint': 'Impressum',
      'contact': 'Kontakt',
      'donations': 'Spenden'
    },
    'about': {
      ...
      'Die Gäste sind herzlich eingeladen, beim Kochen zu helfen oder einfach das Essen zu genießen. ',

      'paragraph3': 'Weil wir soziale Gerechtigkeit zelebrieren, sind alle Meet & Eat-Events für jeden kostenfrei. ',

      'who': 'Wer wir sind',

      'jana': 'Jana gründete Meet & Eat zusammen mit einer Gruppe ehemaliger Europäischer Freiwilliger im Jahr 2015. ' +
      'Sie studiert  in Berlin und ist verantwortlich für die Events, Öffentlichkeitsarbeit und Kommunikation. ',

      'stadtteilzentrum': 'Das Stadtteilzentrum Pankow ist Gastgeber der Meet & Eat-Events. Besonderer Dank ' +
      'geht an Katrin und Ira, die die Anmeldungen und die Logistik organisieren. ',

      'tafeln': 'Die soziale Organisation Berliner Tafel e.V. lebt das Prinzip der Umverteilung. ' +
      'Sie stellen uns die vermeintlich unverkäuflichen Lebensmittel zur Verfügung. Wir sind sehr dankbar, sie unsere Partner ' +
      'nennen zu dürfen.',
    ...
    'imprint': {
      'headline': {
        ...
        'contact': 'Kontakt',
        'image_sources': 'Quellenangaben für die verwendeten Bilder und Grafiken',
        'acc_content': 'Haftung für Inhalt',
        'acc_links': 'Haftung für Links',
